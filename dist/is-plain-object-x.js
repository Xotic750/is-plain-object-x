...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["isPlainObjectX"] = factory();
	else
		root["isPlainObjectX"] = factory();
})((function () {
  'use strict';
...
/* harmony default export */ var is_node_x_esm = (isNode);
...
// CONCATENATED MODULE: ./node_modules/is-prototype-of-x/dist/is-prototype-of-x.esm.js
...
/* harmony default export */ var is_prototype_of_x_esm = (is_prototype_of_x_esm_isPrototypeOf);


// CONCATENATED MODULE: ./dist/is-plain-object-x.esm.js
...
var fnToString = simple_methodize_x_esm(simple_methodize_x_esm.toString);
var objectTag = '[object Object]';
var testNode = typeof document !== 'undefined' && to_string_tag_x_esm(document) === objectTag;

var testArguments = function getTestArgs() {
  /* eslint-disable-next-line prefer-rest-params */
  return to_string_tag_x_esm(arguments) === objectTag;
}();
/**
...
if (typeof window !== 'undefined' && to_string_tag_x_esm(window) === objectTag) {
  $isHostObject = function isHostObject(value) {
    // Many host objects are `Object` objects that can coerce to strings
    // despite having improperly defined `toString` methods.
    if (is_nil_x_esm(value) === false && typeof value.toString === 'function') {
      try {
...
var $isObjectObject = function isObjectObject(value) {
  if (is_primitive_x_esm(value) || typeof value === 'function' || to_string_tag_x_esm(value) !== objectTag) {
    return false;
  }

  if (testArguments && is_arguments_default()(value)) {
    return false;
  }

  if (testNode && is_node_x_esm(value)) {
    return false;
  }
...
var $funcToString = function funcToString(value) {
  if (is_primitive_x_esm(value) === false) {
    try {
...
var is_plain_object_x_esm_obj = {};
var objectCtorString = $funcToString(is_plain_object_x_esm_obj.constructor);
...
var $isPlainObject = function isPlainObject(value) {
  ...
  var proto = get_prototype_of_x_esm(value);
  ...
  if (is_prototype_of_x_esm(proto, is_plain_object_x_esm_obj)) {
    return true;
  }

  var Ctor = has_own_property_x_esm(proto, 'constructor') && proto.constructor;
...
/* harmony default export */ var is_plain_object_x_esm = __webpack_exports__["default"] = ($isPlainObject);
...
//# sourceMappingURL=is-plain-object-x.js.map
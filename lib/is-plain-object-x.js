...
if (element && toStringTag(element) === objectTag) {
  try {
    ...
    tagRx = new RegExp('^\\[object[' + _dereq_('white-space-x').string + ']+[\\s\\S]+\\]$');
...
},{"get-prototype-of-x":3,"is-arguments":6,"is-primitive":10,"lodash.isnull":11,"to-string-tag-x":14,"white-space-x":16}],2:[function(_dereq_,module,exports){
...
},{"is-function-x":7,"lodash.isnull":11,"to-object-x":13}],4:[function(_dereq_,module,exports){
/**
...
},{"has-to-string-tag-x":5,"is-primitive":10,"to-string-tag-x":14}],8:[function(_dereq_,module,exports){
...
},{"require-object-coercible-x":12}],14:[function(_dereq_,module,exports){
/**
...
},{"lodash.isnull":11,"validate.io-undefined":15}],15:[function(_dereq_,module,exports){
/**
*
*	VALIDATE: undefined
*
